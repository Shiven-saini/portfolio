        ...
        <div className="relative px-6 sm:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  className="relative px-4 py-2 text-gray-300 hover:text-white transition-all duration-300 group rounded-lg hover:bg-gradient-to-r hover:from-accent-orange/10 hover:to-accent-yellow/10"
                >
                  {item.label}
            ...
            <motion.button
              ...
              className="md:hidden p-2 text-gray-300 hover:text-white transition-colors rounded-lg hover:bg-gradient-to-r hover:from-accent-orange/10 hover:to-accent-yellow/10"
            >
          ...
          >
            <div className="py-4 space-y-1 border-t border-gray-700/30 mt-2">
              {navItems.map((item) => (
                <button
                  key={item.href}
                  onClick={() => scrollToSection(item.href)}
                  className="block w-full text-left px-4 py-3 text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-accent-orange/10 hover:to-accent-yellow/10 transition-all duration-300 rounded-lg"
                >
                  {item.label}
                </button>
              ))}
